...
## Project Structure
    ...
    ├── testapiautoteammemb_55675  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_55675`
...
2. Clone this repo and `cd testapiautoteammemb_55675`
